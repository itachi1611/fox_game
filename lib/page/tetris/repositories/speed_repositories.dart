...
abstract class SpeedRepositories {
  int getMillisecond(LevelRepositories level) {
    // additionally divide by 2, because moveDown and check collision is in different iteration
...
class NesSpeed extends SpeedRepositories {
...
class PalSpeed extends SpeedRepositories {
  static const Map<int, int> levelToFramePearGridCell = {
    0: 36,
    1: 32,
    2: 29,
